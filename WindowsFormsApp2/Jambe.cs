...
namespace WindowsFormsApp2
{
    class Jambe:Rectangle_Tourne
    {
        ...
        public Jambe(Graphics g, int xjambes, int yjambes, int xlongueur, int yhauteur, Color crayon, Color centercolor, double angle) : base(g, xjambes, yjambes, xlongueur, yhauteur, crayon, centercolor, angle)
        {
            Tibia = new Rectangle_Tourne(g, xjambes, yjambes + yhauteur, xlongueur,
                (yhauteur * 3) / 4, Color.White, Color.White, 0);

            Pied = new Rectangle_Tourne(g, xjambes, yjambes + yhauteur + (yhauteur * 3) / 4,
