...
namespace WindowsFormsApp2
{
    class GardienDroit : Personnage
    {
        ...
        public GardienDroit(Graphics g, int xcorps, int ycorps, int xlongueur, int yhauteur,
            Color crayon, Color centercolor) : base(g, xcorps, ycorps, xlongueur, yhauteur, crayon, centercolor)
        {
            ...
            Corps = new Rectangle(g, xcorps, ycorps, xlongueur, yhauteur, Color.Purple, Color.Purple);
